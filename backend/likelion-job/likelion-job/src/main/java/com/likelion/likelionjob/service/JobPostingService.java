...
public class JobPostingService {
    ...
    public JobPostingDto findOne(String companyName){
        ...
        return new JobPostingDto(entity.getId(), entity.getCompanyName(),entity.getPosition(),entity.getDescription());
    }
    public List<JobPostingDto> findAll(){
        return jobPostingRepository.findAll().stream().
                map(entity->new JobPostingDto(entity.getId(), entity.getCompanyName(),entity.getPosition(),entity.getDescription()))
                .collect(Collectors.toList());
    }
    public JobPostingDto save(JobPostingDto dto){
        JobPosting saved = jobPostingRepository.save(new JobPosting(dto.getCompanyName(), dto.getPosition(), dto.getDescription()));
        return new JobPostingDto(saved.getId(), saved.getCompanyName(),saved.getPosition(),saved.getDescription());
    }
